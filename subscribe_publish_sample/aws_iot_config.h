...
#ifndef SRC_SECURE_TUNNEL_IOT_SECURE_TUNNEL_CONFIG_H_
#define SRC_SECURE_TUNNEL_IOT_SECURE_TUNNEL_CONFIG_H_
...
#endif /* SRC_SECURE_TUNNEL_IOT_SECURE_TUNNEL_CONFIG_H_ */
